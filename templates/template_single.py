...
class NewDataset(datasets.GeneratorBasedBuilder):
    ...
    # You will be able to load the "source" or "bigbio" configurationss with
    # data = datasets.load_dataset('my_dataset', name='source')
    # data = datasets.load_dataset('my_dataset', name='bigbio')
    
    BUILDER_CONFIGS = [
        datasets.BuilderConfig(name="source", version=VERSION, description="Source schema"),
        datasets.BuilderConfig(name="bigbio", version=BIGBIO_VERSION, description="BigScience Biomedical schema"),
    ]
