...
<img src="./docs/_static/img/select-task.jpg" style="width: 50%; border-radius: 5px; border: 1p solid #ddd;"/>
...
<img src="./docs/_static/img/self-assign.jpg" style="width: 50%; border-radius: 5px; border: 1p solid #ddd;"/>
