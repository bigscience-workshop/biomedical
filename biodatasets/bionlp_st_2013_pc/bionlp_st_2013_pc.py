...
_DESCRIPTION = """\
Pathway Curation (PC) task of BioNLP Shared Task 2013
"""
...
class bionlp_st_2013_pc(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(
        ...
        data_files = {
            "train": data_dir / 'bionlp-st-2013-pc-master' / "original-data" / "train",
            "dev": data_dir / 'bionlp-st-2013-pc-master' / "original-data" / "devel",
            "test": data_dir / 'bionlp-st-2013-pc-master' / "original-data" / "test",
        }
