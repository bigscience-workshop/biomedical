# coding=utf-8
# Copyright 2022 The HuggingFace Datasets Authors and Marianna Nezhurina
#
...
class MultiXScience(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        BigBioConfig(
            ...
            description="Multi-XScience source schema",
            schema="source",
        ...
        BigBioConfig(
            ...
            description="Multi-XScienceBigBio schema",
            schema="bigbio_t2t",
            subset_id="Multi_XScience",
        ),
    ]

    DEFAULT_CONFIG_NAME = "Multi-XScience_source"
