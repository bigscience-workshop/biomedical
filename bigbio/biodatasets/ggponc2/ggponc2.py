...
class GgponcDataset(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager) -> List[datasets.SplitGenerator]:
        ...
        dir_lookup = {
            "ggponc2_fine_long_bigbio_kb": data_dir / "annotations/json/fine/long/all.json",
            "ggponc2_fine_short_bigbio_kb": data_dir / "annotations/json/fine/short/all.json",
            "ggponc2_coarse_long_bigbio_kb": data_dir / "annotations/json/coarse/long/all.json",
            "ggponc2_coarse_short_bigbio_kb": data_dir / "annotations/json/coarse/short/all.json",
        }
