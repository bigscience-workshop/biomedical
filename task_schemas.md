...
[Schema Template](biomed_datasets/utils/schemas/kb.py)
...
## Question Answering
- [Schema Template](biomed_datasets/utils/schemas/qa.py)
...
- [Schema Template](biomed_datasets/utils/schemas/entailment.py)
...
- [Schema Template](biomed_datasets/utils/schemas/pairs.py)
...
- [Schema Template](biomed_datasets/utils/schemas/text_to_text.py)
...
## Text
- [Schema Template](biomed_datasets/utils/schemas/text.py)
